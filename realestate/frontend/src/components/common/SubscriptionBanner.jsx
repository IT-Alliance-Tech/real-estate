...
const SubscriptionBanner = ({ variant = 'default' }) => {
  ...
  if (!subscription) {
    if (variant === 'compact') {
      return (
        <div className="subscription-banner-compact not-subscribed">
          <div className="compact-content">
            <span className="banner-icon-small">✨</span>
            <span className="compact-text">
              <strong>Get Full Access:</strong> Subscribe to unlock property details
            </span>
