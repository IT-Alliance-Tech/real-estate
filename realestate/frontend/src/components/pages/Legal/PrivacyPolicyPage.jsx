    ...
    <div className="terms-container">
      ...
      <section className="terms-content">
        ...
        <p className="highlight">
          PLEASE READ THIS PRIVACY POLICY CAREFULLY. BY USING THE REAL ESTATE WEBSITE OR MOBILE PLATFORM, 
          YOU INDICATE THAT YOU UNDERSTAND, AGREE, AND CONSENT TO THIS PRIVACY POLICY.
        </p>

        <h2 className="padd">Introduction</h2>
        <p>
          REAL ESTATE (“we”, “our”, “us”) respects your privacy and is committed to protecting your 
        ...
        <p>
          REAL ESTATE implements industry-standard security measures to protect your data. However, 
        ...
        <p>
          ...
          REAL ESTATE is not responsible for their content or privacy practices. Please review their respective 
          privacy policies.
        </p>
        ...
        <p>
          ...
          <br />
          <strong>Email:</strong> support@realestate.com
          <br />
          <strong>Address:</strong> 123, Real Estate Building, Central Block, Bangalore, India
        </p>
