...
export const API_CONFIG = {
  // Use VITE_BACKEND_BASE_URL from env, otherwise fallback to localhost for development
  // or the production Render URL if not on localhost
  BASE_URL:
    import.meta.env.VITE_BACKEND_BASE_URL ||
    (window.location.hostname === "localhost"
      ? "http://localhost:5001/api"
      : "https://real-estate-798y.onrender.com/api"),
